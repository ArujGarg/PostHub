...
export function SignupFormDemo() {
  ...
  return (
    <div className="">
      ...
      <div className="max-w-md w-full mx-auto mt-16 mb-12 rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-neutral-950 ">
        ...
        <form className="my-8" onSubmit={handleSubmit}>
          <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
            ...
            <LabelInputContainer>
              ...
              <Input id="lastname" placeholder="johndoe123" type="text" />
            </LabelInputContainer>
          </div>
