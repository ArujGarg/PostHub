        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div className="hidden w-full md:block md:w-auto  " id="navbar-default">
                <ul className="font-medium flex flex-row p-4 md:p-0 mt-4 border rounded-lg bg-neutral-900  md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 items-center ">
                        <div className="border px-2 border-neutral-800 cursor-pointer hover:bg-gradient-to-r from-indigo-500 to-purple-500 rounded-sm ">
                        ...
                        <div>
                            <div onClick={() => window.open("https://github.com/ArujGarg/social-media-app" , "_blank")} className=" md:border hover:bg-gradient-to-r hover:from-indigo-500 hover:to-purple-500 border-neutral-800 flex flex-row items-center rounded-sm  cursor-pointer">
                                ...
                                <a className="block py-2 px-3 text-gray-900 p-2 text-white ">Star this project</a>
                            </div>
                        </div>
                        <div className="cursor-pointer">
                            <Link to="/signin" className="block py-2 px-3 h-10 text-gray-900 rounded-sm   hover:bg-gradient-to-r hover:from-indigo-500 hover:to-purple-500  md:border md:p-2 text-white bg-transparent border-neutral-800">Login</Link>
                        </div>    
                </ul>
            </div>
        </div>
