                ...
                <div className="flex">
                    <div className="flex  mt-4 mx-4 mb-2">
                        ...
                        <div className="flex items-center ml-2">
                            ...
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="white" className={`size-5 cursor-pointer hover:fill-purple-700 fill-none  ${post.liked ? "fill-purple-700" : "none"} `}>
